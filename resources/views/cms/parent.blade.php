...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">@yield('capital-starter-page')</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">@yield('home-starter-page')</a></li>
              <li class="breadcrumb-item active">@yield('small-starter-page')</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; {{now()->year}} - {{now()->year + 1}} <a href="https://adminlte.io">@yield('company-name')</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
